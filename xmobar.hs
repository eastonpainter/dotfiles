...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm .|. shiftMask, xK_z     ), spawn "scrot '%F_%T.png' -e 'mv $f /home/easton/pictures/screenshots/'")
...
--
main = do
	xmproc <- spawnPipe "xmobar -x 0 /home/eastonpainter/.xmobarrc"
